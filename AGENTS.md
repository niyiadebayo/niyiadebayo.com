...
4. **No hollow adjectives:** innovative, exciting, unique, transformative, groundbreaking, seamless. (*Robust* was on this list until 2026-07-27 and came off at the author's instruction: it is his own word — "the trust layer was insanely robust" — and it stays. Keep it where it carries weight; it is still filler when applied to a product or a system in the abstract.)
...
13. **No clever compressions. If you reached for the metaphor, it reads as machine.** The tell is a paradox or figure that *sounds* like an insight standing where plain speech belongs. Caught 2026-07-27 on "the business survives arithmetic he has never done" — the author's own replacement was *"the business survives on vibes and tiny margins with no prospects for scale."* Informal, concrete, plainly enumerated. **The test is provenance, not taste:** figurative language traceable to his own mouth reads as him and stays (*exercising that muscle*, *stay longer in the arena*, *within proximity*, *the vector direction*, *the trust layer*, *management span*, *castles in the air / rolling your sleeves*, *air puffing*). Anything you invented gets rewritten plain — "absorbs the leaks" → "eats the small losses himself"; "check for grain" → "check for detail"; "the organization cannot reproduce itself" → "the business cannot produce its next set of managers"; "loses a working day a week to a calendar" → "sits idle one working day out of every week". **Sweep method:** list every figurative or abstract noun in the draft, check each against the interview transcript, rewrite what you cannot trace. Related: rule 12's ban on paragraph-closing aphorisms is the same instinct one level up.
